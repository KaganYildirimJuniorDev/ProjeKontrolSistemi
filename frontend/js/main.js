// API Configuration
const API_BASE_URL = 'https://kagandev-deneme.hf.space/api';
const FILE_BASE_URL = 'https://kagandev-deneme.hf.space/uploads';
...
function initializeSocket(assignmentId) {
    ...
    socket = io('https://kagandev-deneme.hf.space');
